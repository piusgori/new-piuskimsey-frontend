...
const TermsAndConditionsComponent = () => {
  return (
    <div className={classes.container}>
        ...
        <table>
            <tbody>
                <tr className={classes.row}><td className={classes.data}>1.</td><td className={classes.data}>We welcome you to Piuskimsey website. This is an e-commerce platform we have made with love for you to reach as many customers as you desire.</td></tr>
